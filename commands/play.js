    ...
    const embeds = [
      new EmbedBuilder()
        ...
        .setAuthor({
          name: "Request Update!",
          iconURL:
            "https://cdn.discordapp.com/attachments/1230824451990622299/1236794583732457473/7828-verify-ak.gif",
          url: "https://discord.gg/ECyJakuB77",
        })
        .setDescription(
          "➡️ **Your request has been successfully processed.**\n➡️** Please use the buttons to control the queue**",
        ),
      ...
      new EmbedBuilder()
        ...
        .setAuthor({
          name: "Request Update!",
          iconURL:
            "https://cdn.discordapp.com/attachments/1230824451990622299/1236802032938127470/4104-verify-yellow.gif",
          url: "https://discord.gg/ECyJakuB77",
        })
        .setDescription(
          "➡️ **Your request has been successfully processed.**\n➡️** Please use the buttons to control the queue**",
      ...
      new EmbedBuilder()
        ...
        .setAuthor({
          name: "Request Update!",
          iconURL:
            "https://cdn.discordapp.com/attachments/1230824451990622299/1236802049190920202/4104-verify-red.gif",
          url: "https://discord.gg/ECyJakuB77",
        })
        .setDescription(
          "➡️ **Your request has been successfully processed.**\n➡️** Please use the buttons to control the queue**",
